import {
  ADD_FAMILY_MEMBER, DELETE_FAMILY_MEMBER_FAILURE, DELETE_FAMILY_MEMBER_REQUEST,
  DELETE_FAMILY_MEMBER_SUCCESS, GET_ALL_FAMILY_MEMBERS, GET_ALL_FAMILY_MEMBERS_FAILURE, GET_ALL_FAMILY_MEMBERS_REQUEST,
  GET_ALL_FAMILY_MEMBERS_SUCCESS, GET_FAMILY_MEMBER_BY_ID, UPDATE_FAMILY_MEMBER, UPDATE_FAMILY_MEMBER_FAILURE, UPDATE_FAMILY_MEMBER_REQUEST,
  UPDATE_FAMILY_MEMBER_SUCCESS
} from "./actionTypes";

export const getAllFamilyMembers = members => {
  return {
